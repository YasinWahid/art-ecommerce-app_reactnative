...
const AboutUsScreen = () => {
  const [userCount, setUserCount] = useState(0);
    ...
    const handleIncrementUserCount = () => {
      setUserCount(userCount + 1);
    };
  
    // Function to decrement the user count (optional)
    const handleDecrementUserCount = () => {
      setUserCount(userCount - 1);
    };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.teamContainer}>
        ...
        <View style={styles.developerContainer}>
         ...
         {/* Up and Down arrows for user count */}
         <View style={styles.arrowContainer}>
        <TouchableOpacity
          style={styles.arrowButton}
          onPress={handleIncrementUserCount}
        >
          <Text style={styles.arrowText}>↑</Text>
        </TouchableOpacity>
 {/* Display the user count */}
 <Text style={styles.users}>
        Total Users In ArtSello: {userCount}
      </Text>
        <TouchableOpacity
          style={styles.arrowButton}
          onPress={handleDecrementUserCount}
        >
          <Text style={styles.arrowText}>↓</Text>
        </TouchableOpacity>
      </View>
